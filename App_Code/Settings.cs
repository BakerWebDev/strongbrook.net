...
public static class GlobalSettings
{
    ...
    {
        public static string LoginName                          = "API_Strongbrook"; // "API_Username";
        public static string Password                           = "strongbrookapi"; // API_Password";
        public static string CompanyKey                         = "strongbrook"; // exigodemo";
    }

    public static class ExigoPaymentApiCredentials
    {
        public static string LoginName                          = "strongbrook_3iihoa42P";
        public static string Password                           = "EOmw8jaZp9CS6vr7YLlpUDVU";
    }
    ...
    public static class Markets
    {
        ...
        public static string LanguageCookieName                 = "CurrentLanguage";
    ...
    {
        public static string SMTPServerUrl                      = "smtpout.secureserver.net";
        public static int SMTPServerPort                        = 25;
        public static bool SMTPSecureConnectionRequired         = false;
        public static string SMTPServerLoginName                = "support@strongbrookdirect.com";
        public static string SMTPServerPassword                 = "Reic2012";
        public static string WebmasterEmailAddress              = "aaron.baker@strongbrook.com";
        public static string NoReplyEmailAddress                = "noreply@strongbrook.com";
    }
    ...
    {
        public static string Name                               = "Strongbrook";
        public static string Address                            = "531 E 770 N";
        public static string City                               = "Orem";
        public static string State                              = "Utah";
        public static string Zip                                = "84097";
        public static string Country                            = "United States";
        public static string Phone                              = "(801)841-3300";
        public static string Email                              = "support@strongbrook.com";
