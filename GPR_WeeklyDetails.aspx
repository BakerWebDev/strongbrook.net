<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeFile="GPR_WeeklyDetails.aspx.cs" Inherits="GPR_WeeklyDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <div class="sidebar">
        <navigation:GamePlanReports ID="SideNavigation" ActiveNavigation="weekly" runat="server" />
    </div>
        ...
        <div class="well well-white list">
            ...
            <div id="searchwrapper">
                ...
                <select id="lstSearchField" class="input-medium">
                    ...
                    <option value="PeriodVolume.Volume83" data-fieldtype="int">Weekly Personal</option>
                    <option value="PeriodVolume.Volume82" data-fieldtype="int">Lifetime Personal</option>
                    <option value="PeriodVolume.Volume99" data-fieldtype="int">Weekly Organizaion</option>
            ...
            <div class="gridreporttablewrapper">
                <table class="table gridreporttable" id="gridreporttable">
                    <tr class="table-headers">
                        ...
                        <th><a class="sortable" data-field="PeriodVolume.Volume83">Weekly Personal</a></th>                        
                        <th><a class="sortable" data-field="PeriodVolume.Volume82">Lifetime Personal</a></th>
                        <th><a class="sortable" data-field="PeriodVolume.Volume99">Weekly Organizaion</a></th>
