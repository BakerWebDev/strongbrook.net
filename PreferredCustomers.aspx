<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeFile="PreferredCustomers.aspx.cs" Inherits="PreferredCustomers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <div class="sidebar">
        <navigation:Organization id="SideNavigation" ActiveNavigation="preferredcustomers" runat="server" />
    </div>
    <div class="maincontent">
        <h2>Preferred Customers</h2>
