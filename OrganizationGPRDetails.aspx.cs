...
public partial class OrganizationGPRDetails : System.Web.UI.Page
{
            ...
            switch(Request.QueryString["action"])
            {
                case "fetch":
                    ...
                    foreach(var record in nodes)
                    {
                        ...
                        html.AppendFormat("<td>{0:N0}</td>", record.VolumeColumn8);
                        html.AppendFormat("<td>{0:N0}</td>", record.VolumeColumn9);
                        html.AppendFormat("<td>{0:N0}</td>", record.VolumeColumn10);
