...
public partial class GPRform : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //if (timeZoneSelection2 == null)
            //{
            //    PopulateAvailabilityFields2();
            //}
    ...
    private void PopulateNetWorthFields3()
    {
        netWorth.Items.Clear();
    ...
    private void PopulateAppointmentTimeFields()
    {
        netWorth2.Items.Add(new ListItem("from 6:00AM to 6:30AM"));
        netWorth2.Items.Add(new ListItem("from 6:30AM to 7:00AM"));        
    }




    private void PopulateAppointmentTimeFields2()
    {
        #region Populate Dropdown
        Response.Expires = -1;
        Response.ContentType = "text/plain";
            ...
            case "Hawaii Time":
                switch (timeFrameSelection)
                {
                    case "Sunday":
                        ...
                        netWorth2.Items.Add(new ListItem(closedSunday));


                        Response.Write(closedSunday);
                        break;
                    case "Monday":
            ...
            case "Pacific Time":
                switch (timeFrameSelection)
                {
                    ...
                    case "Monday":
                        ...
                        netWorth2.Items.Add(new ListItem("from 10:00AM to 6:30AM"));
                        netWorth2.Items.Add(new ListItem("from 6:30AM to 7:00AM"));
    ...
    public string NetWorth2
    {
        get { return netWorth2.SelectedValue; }
        set { netWorth2.SelectedValue = value; }
    }
