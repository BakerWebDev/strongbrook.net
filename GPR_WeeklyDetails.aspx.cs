...
public partial class GPR_WeeklyDetails : System.Web.UI.Page
{
        ...
        var nodes = query.Select(c => new ReportDataNode
            {
                ...
                VolumeColumn4   = c.PeriodVolume.Volume83,  // Column 4 - Weekly    Personal        GPR Credits
                VolumeColumn5   = c.PeriodVolume.Volume82,  // Column 5 - Lifetime  Personal        GPR Credits
                VolumeColumn6   = c.PeriodVolume.Volume99,  // Column 6 - Weekly    Organizaional   GPR Credits
