<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeFile="PersonallyEnrolledTeam.aspx.cs" Inherits="PersonallyEnrolledTeam" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="Server">
    ...
    <script>
        ...
        $(function () {
            // Report
            setInitialSort('Customer.CreatedDate', report.sortOrderTypes.DESCENDING);
            initializeReport();
        ...
        <div class="well well-white list">
            <div id="searchwrapper">
                ...
                <select id="lstSearchField" class="input-medium">
                    ...
                    <option value="PeriodVolume.RankID" data-fieldtype="int" data-source="ranks">Rank</option>
