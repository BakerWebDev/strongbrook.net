<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master"
    AutoEventWireup="true" CodeFile="ShoppingCheckoutPayment.aspx.cs" Inherits="ShoppingCheckoutPayment" %>
        ...
        <div class="well well-large well-white">
            <div id="shopping">
                <div id="shoppingcheckout">
                    ...
                    <table id="paymentmethodsonfile">
                        <tr>
                            <th colspan="2" class="options"><%=Resources.Shopping.YourStoredPaymentMethods %>
                            </th>
                            <th class="nameoncard"><%=Resources.Shopping.NameOnCardAccount %> </th>
                            <th class="expirationdate"><%=Resources.Shopping.ExpiresOn %> </th>
                        </tr>
                    ...
                    <% if(Shopping.Payments.AvailablePaymentMethodTypes.Contains(Exigo.WebService.PaymentType.CreditCard))
                       { %>
                        ...
                        <table class="newpaymentmethod">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <h3><%=Resources.Shopping.CreditDebitEndingIn %></h3>
                                    <p>
                                        <%=string.Format(Resources.Shopping.CardsAccepted, GlobalSettings.Company.Name) %>
                                    </p>
                                    <div id="newcreditcardfieldswrapper" paymentmethod="Card" validationgroup="NewCard"
                                        style="DISPLAY: none">
                                        <br />
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td class="fieldlabel"><%=Resources.Shopping.YourName %> </td>
                                                <td class="fields">
                                            ...
                                            <tr>
                                                <td class="fieldlabel"><%=Resources.Shopping.YourCardNumber %> </td>
                                                <td class="fields">
                                                    <div class="fieldwrapper width255">
                                            ...
                                            <tr>
                                                <td class="fieldlabel"><%=Resources.Shopping.YourExpiDate %> </td>
                                                <td class="fields">
                                            ...
                                            <tr>
                                                <td class="fieldlabel"><%=Resources.Shopping.YourSecurityCode %> </td>
                                                <td class="fields">
                                                    <div class="fieldwrapper width255">
                                                        <asp:TextBox ID="txtCreditCardCvc" runat="server" CssClass="validate[required,custom[onlyNumberSp],min[3]] text-input" />
                                                        <div class="fieldinstructions">
                                            ...
                                            <tr>
                                                <td class="fieldlabel"><%=Resources.Shopping.YourBillingAddress %> </td>
                                                <td class="fields">
                                                    <div class="fieldwrapper width255">
                                                    ...
                                                    <div class="fieldwrapper width120" style="display: <%=(Shopping.AddressSettings.AllowZipCode) ? "block" : "none" %>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fields">
                                                    <br />
                                                    <a href="javascript:UseNewCard();" class="btn btn-success"><%=Resources.Shopping.UseThisCard %></a>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                    ...
                    <% if(Shopping.Payments.AvailablePaymentMethodTypes.Contains(Exigo.WebService.PaymentType.ACHDebit))
                       { %>
                    <div class="newpaymentmethodwrapper">
                        <table class="newpaymentmethod">
                            <tr>
                                ...
                                <td>
                                    <div class="usenewpaymentmethodbuttonwrapper">
                                        <a class="btn btn-success" paymentmethod="CheckingAccount" onclick="ToggleNewPaymentMethodFieldsWrapper('CheckingAccount')">
                                            <%=Resources.Shopping.UseANewCheckingAccount %></a>
                                    </div>
                                    <h3><%=Resources.Shopping.CheckingAccount %></h3>
                                    <p><%=Resources.Shopping.UseYourCheckingAccount %>
                                    </p>
                                    <div id="newcheckingaccountfieldswrapper" paymentmethod="CheckingAccount" validationgroup="NewBankAccount"
                                        style="DISPLAY: none">
                                        <br />
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="fieldlabel"><%=Resources.Shopping.YourAccountNumber %> </td>
                                                <td class="fields">
                                                    <div class="fieldwrapper width255">
                                            ...
                                            <tr>
                                                <td class="fieldlabel"><%=Resources.Shopping.YourRoutingNumber %> </td>
                                                <td class="fields">
                                                    <div class="fieldwrapper width255">
                                            ...
                                            <tr>
                                                <td class="fieldlabel"><%=Resources.Shopping.YourBank %> </td>
                                                <td class="fields">
                                                    <div class="fieldwrapper width255">
                                            ...
                                            <tr>
                                                <td class="fieldlabel"><%=Resources.Shopping.YourBanksAddress %> </td>
                                                <td class="fields">
                                                    <div class="fieldwrapper width255">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fields">
                                                    <br />
                                                    <a href="javascript:UseNewBankAccount();" class="btn btn-success"><%=Resources.Shopping.UseThisCheckingAccount %></a></td>
                                            </tr>
                                        </table>
                                    </div>
                                </td>
