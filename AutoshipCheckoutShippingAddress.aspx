<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master"
    AutoEventWireup="true" CodeFile="AutoshipCheckoutShippingAddress.aspx.cs" Inherits="AutoshipCheckoutShippingAddress" %>
        ...
        <div class="well well-large well-white">
            <div id="shopping">
                <div id="shoppingcheckout">
                    ...
                    <h2><%=Resources.Shopping.ShippingAddress %></h2>

                    <% if(HasOneOrMoreValidAddressesOnFile())
                       { %>
                    <p><%=Resources.Shopping.ShippingAddressOnFileConfirmationMessage %>
                    </p>
                    <br />
                    <table width="100%">
                        <tr>
                            <% RenderAddress(AutoshipCartPropertyBag.AddressType.Main); %>
                            <% RenderAddress(AutoshipCartPropertyBag.AddressType.Mailing); %>
                            <% RenderAddress(AutoshipCartPropertyBag.AddressType.Other); %>
                        </tr>
                    </table>
                    <br />
                    <br />
                    ...
                    <div validationgroup="NewShippingAddress">
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="fields">
                                    <br />
                                    <a href="javascript:ShipToNewAddress();" class="btn btn-success Next"><%=Resources.Shopping.ShipToThisAddress %></a>
                                </td>
                            </tr>
                        </table>
                    </div>
