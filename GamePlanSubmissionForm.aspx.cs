...
public partial class GPRform : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Request.Cookies["userCookie"].Expires.AddSeconds(1);
            }
    ...
    // An attempt to only show the AppointmentDate field on the email if the RadioBuuttonSchedule button is checked.
